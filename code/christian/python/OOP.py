...
class BankAccount:
    ...
    def deposit(self):
        print(f"Thank you {self.name} for choosing to 'Deposit' funds to account number {self.accountNumber}.")
    ...
    def withdrawal(self):
        print(f"Thank you {self.name} for choosing to 'Withdrawal' funds from account number {self.accountNumber}.")
...
class Rectangle:
    ...
    def display(self):
        print(f"The length of the area is {self.length} while the width is {self.width}. Therefore: \n")
        self.perimeter()
        self.area()
